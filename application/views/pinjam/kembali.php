				            ...
				            <td>
				              <form>
				                ...
				                foreach ($pin as $isi) {
				                  ...
				                  echo '<label>' . $buku->title . '</label><br/>';
				                  echo '<input type="checkbox" name="condition[' . $buku->buku_id . '][]" value="sobek"> Sobek<br/>';
				                  echo '<input type="checkbox" name="condition[' . $buku->buku_id . '][]" value="rusak"> Rusak<br/>';
				                  echo '</div>';
				                }
				                ?>
				              </form>
